                ...
                <form method="POST" @submit.prevent="updatePopup()" >
                    ...
                    <div class="row">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-4">
                                <img :src="popup.photo.kepUtvonal" class="float-start m-2 modalkep img-fluid rounded mx-auto d-block"/>
                                </div>
                        </div>
                            <div class="col-6">
