...
const { products, addNewProduct, disableBtnAdd, photoMessage, showUp, showDown} = storeToRefs(OrdersStore())
const { update, fetchOrders, addNewProductBtn, onChange, createProduct, deleteProduct, orderByProductsAz, orderByProductsZa, updateProduct } = OrdersStore()
fetchOrders();
</script>
